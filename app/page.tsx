...
const process = [
  ...
  },
  {
    step: 'Launch + Iterate',
    title: '',
    body: 'Publicamos, medimos impacto y optimizamos conversión con mejoras continuas.',
  },
  {
    step: 'Launch care',
    title: '',
    body: 'Brindamos soporte técnico post entrega durante un período de tiempo para que te sientas más cómodo en las primeras etapas de uso del producto.',
  },
]
...
const projects = [
  {
    ...
    result: 'Ganadería y agricultura',
    detail: 'Soluciones para trazabilidad, reportes y eficiencia en campo.',
  },
  {
    name: 'E-commerce',
    result: 'Implementaciones headless end to end',
    detail: 'Arquitecturas SaaS para crecer sin fricción.',
  },
  {
    name: 'Integraciones',
    result: 'CRM, Wix y otros',
    detail: 'Conectamos tu stack comercial y operativo para que todo hable entre sí.',
  },
  {
    name: 'Consultoría',
  ...
  },
  {
    ...
    detail: 'De esta manera podés desarrollar, probar, desplegar y gestionar aplicaciones en la nube sin manejar la infraestructura subyacente.',
  },
  {
    name: 'Games',
    result: 'Mobile y PC',
    detail: 'Desarrollo e implementaciones de juegos multiplataformas para experiencias más fluidas.',
  },
]
  ...
  return (
    <main className={styles.main}>
        ...
        <div className={styles.heroTop}>
          <div className={styles.heroCopy}>
            ...
            <p className={styles.heroLead}>
              Somos una empresa de sistemas cercana y resolutiva. Diseñamos y desarrollamos
              sitios, plataformas y automatizaciones para que avances rápido y con claridad.
            </p>
            <div className={styles.heroActions}>
              <a href="#contacto" className={styles.btnPrimary}>Empezar proyecto</a>
              <a href="#casos" className={styles.btnSecondary}>Nuestro alcance</a>
            </div>
          </div>
          <div className={styles.heroPanel}>
            <div className={styles.heroPanelGlow} />
            <div className={styles.heroPanelCard}>
              <p>Impacto promedio en 90 días</p>
              <strong>+38% conversión</strong>
              <span>Con una mezcla simple: UX claro, velocidad técnica y enfoque comercial</span>
            </div>
          </div>
        </div>
      ...
      <section id="proceso" className={styles.process}>
        <div className={styles.sectionHead}>
          <p>Proceso</p>
          <h2>Transparencia en la construcción</h2>
        </div>
      ...
      <section className={styles.cta} id="contacto">
        <div className={styles.ctaContent}>
          <h2>Si tu negocio está listo para crecer, nosotros para construirlo</h2>
          <p>
            Contanos tu objetivo y evaluamos la mejor manera de acompañarte a lograrlo.
          </p>
      ...
      <footer className={styles.footer}>
        ...
        <p>Tu compañero digital para construir software que vende.</p>
      </footer>
    </main>
  )
}
